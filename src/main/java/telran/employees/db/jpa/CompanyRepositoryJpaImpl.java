...
public class CompanyRepositoryJpaImpl implements CompanyRepository{
    ...
    public CompanyRepositoryJpaImpl(PersistenceUnitInfo persistenceUnit, HashMap<String, Object> properties) {
        try {
    ...
    public Employee removeEmployee(long id) {
        ...
        EmployeeEntity emplEntity = em.find(EmployeeEntity.class, id);
        if(emplEntity == null) {
            throw new NoSuchElementException("Employee doesn not exist");
        } 
        try {
        transaction.begin();
    ...
    @Override
    public List<Manager> findManangerWithMostFactor() {
